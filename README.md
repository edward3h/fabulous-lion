...
This is what I *want* to work, not everything that is done yet.

- It should be written in modern JS (Babel)
- React app front end
- login via Facebook (and only Facebook for now)
- save data in sqlite for user